...
/**
 * Servlet implementation class SelectCourseByTeacherServlet
 */
public class SelectCourseByTeacherServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		int teacherId = Integer.parseInt(request.getParameter("selectByTeacher"));
		CourseDAO courseDAO = DAOFactory.getInstance().getCourseDAO();
		try {
			List<Course> coursesList = courseDAO.getAllCourseByTeacherId(teacherId);
