...
/**
 * Servlet Filter implementation class StudentRoleCheckFilter
 */
public class StudentRoleCheckFilter implements Filter {
	...
	public void doFilter(ServletRequest req, ServletResponse res, FilterChain filterChain) throws IOException, ServletException {
		...
		if(user != null && authorization.isStudent(user)) {
